...
| 200 | AUTH_SUCCESS | GET /auth/me 사용자 정보, POST /auth/refresh 새 Access Token |
...
| 400 | INVALID_FILE_FORMAT, INVALID_FILE_TYPE, INVALID_IMAGE_FILE, FILE_SIZE_EXCEEDED | 파일/URL 검증 실패 |
