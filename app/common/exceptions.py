...
class BaseProjectException(Exception):
    ...
    def __init__(
        self,
        status_code: int = 500,
        code: Union[ApiCode, str] = ApiCode.INTERNAL_SERVER_ERROR,
...
class EmailAlreadyExistsException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=409, code=ApiCode.EMAIL_ALREADY_EXISTS, message=message
        )
...
class NicknameAlreadyExistsException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=409, code=ApiCode.NICKNAME_ALREADY_EXISTS, message=message
        )
...
class MissingRequiredFieldException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=400, code=ApiCode.MISSING_REQUIRED_FIELD, message=message
        )
...
class SignupImageTokenInvalidException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=400, code=ApiCode.SIGNUP_IMAGE_TOKEN_INVALID, message=message
        )
...
class CommentNotFoundException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=404, code=ApiCode.COMMENT_NOT_FOUND, message=message
        )
...
class InvalidPostIdFormatException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=400, code=ApiCode.INVALID_POSTID_FORMAT, message=message
        )
...
class AlreadyLikedException(BaseProjectException):
    ...
    def __init__(self, data: Optional[dict] = None, message: Optional[str] = None):
        super().__init__(
            status_code=200,
...
class InvalidImageFileException(BaseProjectException):
    ...
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=400, code=ApiCode.INVALID_IMAGE_FILE, message=message
        )
...
class FileSizeExceededException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=400, code=ApiCode.FILE_SIZE_EXCEEDED, message=message
        )
...
class InvalidFileTypeException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=400, code=ApiCode.INVALID_FILE_TYPE, message=message
        )
...
class InternalServerErrorException(BaseProjectException):
    def __init__(self, message: Optional[str] = None):
        super().__init__(
            status_code=500, code=ApiCode.INTERNAL_SERVER_ERROR, message=message
        )
...
class NotFoundException(BaseProjectException):
    def __init__(
        self,
        code: Union[ApiCode, str] = ApiCode.NOT_FOUND,
        message: Optional[str] = None,
    ):
