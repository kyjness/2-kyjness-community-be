...
async def deliver_notification_sns_async(
    *,
    ...
    await publish_sns(settings.SNS_TOPIC_ARN, json.dumps(payload, ensure_ascii=False))
    await mark_delivered(redis, idempotency_key, settings.CELERY_TASK_IDEMPOTENCY_TTL_SECONDS)
